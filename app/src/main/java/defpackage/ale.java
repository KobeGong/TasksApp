...
final /* synthetic */ class ale implements java.util.concurrent.Callable {
    ...
    public final java.lang.Object call() {
        ...
        for (defpackage.ajo ajo : list) {
            ...
            defpackage.dcb c = defpackage.any.get().c().c(ajo.getTaskListId());
            if (c != null) {
                dby = defpackage.any.get().c().a(ajo.getTaskListId(), ajo.getTaskId());
            }
            if (dby != null) {
                arrayList.add(defpackage.akz.a(c, dby));
            } else {
                defpackage.azb.b("Result not found in local database: %s, %s, %s", defpackage.any.get().c().b(), ajo.getTaskListId(), ajo.getTaskId());
            }
        }
        return arrayList;
    }
