...
/* compiled from: PG */
public final class LinearLayoutManager extends LayoutManager implements aif {
    private int n;
    private adz o;
    private aep p;
    private boolean q;
    ...
    private final int i(aft aft) {
        ...
        int min = Math.min(LayoutManager.a(a), LayoutManager.a(b));
        int max2 = Math.max(LayoutManager.a(a), LayoutManager.a(b));
        if (z3) {
        ...
        return Math.round(((float) (aep.b() - aep.a(a))) + ((((float) Math.abs(aep.b(b) - aep.a(a))) / ((float) (Math.abs(LayoutManager.a(a) - LayoutManager.a(b)) + 1))) * ((float) max)));
    }
    ...
    private final int j(aft aft) {
        ...
        if (!z2) {
            return Math.abs(LayoutManager.a(a) - LayoutManager.a(b)) + 1;
        }
    ...
    private final int k(aft aft) {
        ...
        return (int) ((((float) (aep.b(b) - aep.a(a))) / ((float) (Math.abs(LayoutManager.a(a) - LayoutManager.a(b)) + 1))) * ((float) aft.a()));
    }
        ...
        while (true) {
            ...
            if (adz.j != null) {
                ...
                while (true) {
                    ...
                    View view2 = ((ViewHolder) adz.j.get(i7)).a;
            ...
            if (view == null) {
                ...
                int i8 = e.top;
                int a = LayoutManager.a(this.l, this.j, e.left + e.right + 0 + l() + n() + afh3.leftMargin + afh3.rightMargin, afh3.width, d());
                int a2 = LayoutManager.a(this.m, this.k, e.bottom + i8 + 0 + m() + o() + afh3.topMargin + afh3.bottomMargin, afh3.height, e());
