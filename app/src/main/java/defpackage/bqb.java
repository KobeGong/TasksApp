...
public class bqb {
    ...
    private static final android.net.Uri b = android.net.Uri.parse("content://com.google.android.gsf.gservices");
    private static final android.net.Uri c = android.net.Uri.parse("content://com.google.android.gsf.gservices/prefix");
    ...
    private static final java.util.HashMap g = new java.util.HashMap();
    private static final java.util.HashMap h = new java.util.HashMap();
    private static final java.util.HashMap i = new java.util.HashMap();
    private static final java.util.HashMap j = new java.util.HashMap();
    ...
    private static void a(android.content.ContentResolver contentResolver) {
        if (f == null) {
            ...
            l = false;
            contentResolver.registerContentObserver(b, true, new defpackage.bqc());
    ...
    private static java.lang.String b(android.content.ContentResolver r9, java.lang.String r10) {
        /*
            ...
            r8 = 1
            r2 = 0
            java.lang.Class<bqb> r1 = defpackage.bqb.class
            monitor-enter(r1)
        ...
        L_0x00a6:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bqb.b(android.content.ContentResolver, java.lang.String):java.lang.String");
    }

    private static void a(java.lang.Object obj, java.lang.String str, java.lang.String str2) {
        synchronized (defpackage.bqb.class) {
            if (obj == k) {
                f.put(str, str2);
            }
        }
    ...
    public static long a(android.content.ContentResolver contentResolver, java.lang.String str) {
        java.lang.Long l2;
        long j2;
        java.lang.Object b2 = b(contentResolver);
        java.lang.Long l3 = (java.lang.Long) a(i, str, (java.lang.Object) java.lang.Long.valueOf(-1));
        if (l3 != null) {
            return l3.longValue();
        }
        java.lang.String b3 = b(contentResolver, str);
        if (b3 == null) {
            l2 = l3;
            j2 = -1;
        } else {
            try {
                long parseLong = java.lang.Long.parseLong(b3);
    ...
    public static boolean a(android.content.ContentResolver contentResolver, java.lang.String str, boolean z) {
        java.lang.Object b2 = b(contentResolver);
        java.lang.Boolean bool = (java.lang.Boolean) a(g, str, (java.lang.Object) java.lang.Boolean.valueOf(z));
        if (bool != null) {
        ...
        if (b3 != null && !b3.equals("")) {
            if (d.matcher(b3).matches()) {
                ...
                android.util.Log.w("Gservices", "attempt to read gservices key " + str + " (value \"" + b3 + "\") as boolean");
            }
        }
        a(b2, g, str, bool);
        return z;
    ...
    private static java.lang.Object a(java.util.HashMap r2, java.lang.String r3, java.lang.Object r4) {
        ...
        L_0x0016:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bqb.a(java.util.HashMap, java.lang.String, java.lang.Object):java.lang.Object");
    }
