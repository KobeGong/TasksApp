...
/* compiled from: PG */
final class dle extends defpackage.dlh {
    dle(sun.misc.Unsafe unsafe) {
        super(unsafe);
    }

    public final void a(long j, byte b) {
        libcore.io.Memory.pokeByte((int) (-1 & j), b);
    }
    ...
    public final void a(byte[] bArr, long j, long j2, long j3) {
        libcore.io.Memory.pokeByteArray((int) (-1 & j2), bArr, (int) j, (int) j3);
    }
}
