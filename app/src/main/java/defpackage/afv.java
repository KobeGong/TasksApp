...
public class afv {
    ...
    public afv(View view, byte b2) {
        this(view);
    }

    public afv(View view, char c2) {
        this(view, (byte) 0);
    }

    public afv(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        this(layoutInflater.inflate(R.layout.design_navigation_item_separator, viewGroup, false), (byte) 0);
    }

    public afv(LayoutInflater layoutInflater, ViewGroup viewGroup, byte b2) {
        this(layoutInflater.inflate(R.layout.design_navigation_item_subheader, viewGroup, false), (byte) 0);
    }

    public afv(Context context, ViewGroup viewGroup, ces ces) {
