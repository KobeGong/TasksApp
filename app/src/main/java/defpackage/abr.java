...
/* compiled from: PG */
public class abr extends android.widget.ImageButton implements defpackage.sm, defpackage.vu {
    private final defpackage.abg a;
    private final defpackage.abs b;

    public abr(android.content.Context context) {
        this(context, null);
    }

    public abr(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, 2130772193);
    }

    public abr(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
