...
final class fs implements defpackage.zf {
    private final /* synthetic */ BaseNavigationView navigationView;

    fs(BaseNavigationView baseNavigationView) {
        this.navigationView = baseNavigationView;
    }
    ...
    public final boolean a(MenuBuilder zeVar, android.view.MenuItem menuItem) {
        ...
        if (this.navigationView.e == null) {
            return false;
        }
        defpackage.ft ftVar = this.navigationView.e;
