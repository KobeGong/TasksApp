...
final /* synthetic */ class apk implements java.lang.Runnable {
    ...
    public final void run() {
        ...
        try {
            if (((AbsAccountSetupResult) this.d.get()).isSuccess()) {
                ...
                AbsActivityConfig activityConfig = aoe.a(taskListsActivity, deviceOwner.accountName());
                ...
                if (activityConfigFragment != null) {
                    ...
                    a4.replace(2131755276, welcomeFragment, "cannotInitializeAccount");
                    a4.addToBackStack();
