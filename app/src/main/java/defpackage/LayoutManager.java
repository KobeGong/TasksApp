...
public abstract class LayoutManager {
    ...
    public final void a(View view, int i2, boolean z) {
        ...
        if (c2.g() || c2.e()) {
            ...
            if (c3 == -1) {
                ...
                ViewHolder c4 = RecyclerView.c(e2);
                if (c4.m()) {
                    afd.b.h.b(c4);
                } else {
                    afd.b.h.c(c4);
    ...
    public View a(int i2) {
        ...
        for (int i3 = 0; i3 < k2; i3++) {
            View e2 = e(i3);
            ViewHolder c2 = RecyclerView.c(e2);
    ...
    public final void a(afn afn) {
        ...
        for (int i2 = size - 1; i2 >= 0; i2--) {
            View view = ((ViewHolder) afn.a.get(i2)).a;
            ViewHolder c2 = RecyclerView.c(view);
            if (!c2.b()) {
                c2.a(false);
                if (c2.n()) {
    ...
    public void a(AccessibilityEvent accessibilityEvent) {
        ...
        if (this.b != null && accessibilityEvent != null) {
            ...
            if (this.b.adapter != null) {
                accessibilityEvent.setItemCount(this.b.adapter.getCount());
            }
        }
    }
